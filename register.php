...
<body class="sign-in-basic">
          ...
          <div class="card z-index-0 fadeIn3 fadeInBottom">
            ...
            <div class="card-body mt-4">
              <form action="include/request.php" method="post"  class="text-start form" enctype="multipart/form-data">
                ...
                <div class="input-group input-group-outline mb-3">
                  <b>Profile Picture</b>
                 <input type="file"  name="image" class="form-control" style="margin-top:30px;margin-left:-105px;" accept=".png, .jpg, .jpeg" required>
                </div>
  ...
  <script src="files/assets/js/material-kit.min.js?v=3.0.4" type="text/javascript"></script>
